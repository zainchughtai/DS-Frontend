          ...
          <div className="custom-row align-items-center">
            <div className="feature-left d-flex">
              <div className="feature-img-card">
                <h4>
                  Start your <br /> project from <br /> your pocket.
                </h4>
                <img alt="" decoding="async" src="/images/feature-img-1.png" />
              </div>
              <div className="feature-img-card">
                <h4>
                  Available on <br /> all responsive <br /> devices.
                </h4>
            ...
            <div className="feature-right">
              <div className="feature-content">
                ...
                <h2 className="section-title">Seamless productivity with our new app</h2> <p>Download Slack and experience a new era of organization and accomplishment.</p>
                <ul>
                  <li>
                ...
                <div className="btns-group">
                  <a target="_blank" href="#" className="theme-simple-btn">
